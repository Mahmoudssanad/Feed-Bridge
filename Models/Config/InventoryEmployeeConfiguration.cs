...
{
    public class InventoryEmployeeConfiguration : IEntityTypeConfiguration<InventoryEmployee>
    {
        public void Configure(EntityTypeBuilder<InventoryEmployee> builder)
        {
            ...
            builder.HasOne(x => x.Admin).WithMany(x => x.InventoryEmployees)
                .HasForeignKey(x => x.Admin_id)
                .OnDelete(DeleteBehavior.NoAction);

            builder.ToTable("InventoryEmployees");
        }
    }
}
